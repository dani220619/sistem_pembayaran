                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        if ($u->status_bayar != 'Lunas') {
                                            echo anchor('pembayaran/spp_bulanan/' . $u->id_pem_bulan . '/' . $u->nisn, '<input type=submit class="btn btn-warning" value=\'bayar\'>');
                                        }
                                        echo anchor('pembayaran/cetak_spp_bulanan/' . $u->id_pem_bulan . '/' . $u->nisn, 'Cetak', array('title' => 'Cetak kartu SPP', 'class' => 'btn btn-info'));
                                        ?>
                                    </td>
                                </tr>
                            <?php } ?>
