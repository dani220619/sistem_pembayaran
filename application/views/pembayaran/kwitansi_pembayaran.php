...
<div class="container-fluid">
	...
	<center>
		<table>
			<tr>
				<td>
					<img src="<?= base_url('assets/assets/images/logo/logo.jpg') ?>" style="width: 100px; height: 100px;">
				</td>
				<td>
					<center>
	...
	<table class="table">
		<tbody>
			<tr>
				...
				<td style="width: 75%;text-align: left"><strong><?= $siswa->nama . ' (NIS: ' . $siswa->nisn . ')' ?></strong></td>
			</tr>
			<tr>
				<td style="width: 25%;text-align: left">Banyaknya Uang: </td>
				<td style="width: 75%;text-align: left"><strong><?= terbilang($tag_buku->besar_tagihan) ?> Rupiah</strong></td>
			</tr>
			<tr>
				<td style="width: 25%;text-align: left">Untuk Pembayaran: </td>
				<td style="width: 75%;text-align: left"><strong><?= $tag_buku->jenis_pembayaran ?></strong></td>
			</tr>
			<tr>
				<td style="width: 25%;text-align: left">Jumlah Rp: </td>
				<td style="width: 75%;text-align: left"><strong><?= number_format($tag_buku->besar_tagihan, 0, ',', '.') ?>,-</strong></td>
			</tr>
		</tbody>
	</table>
	<table class="table">
		<tbody>
			<tr>
				...
				<td style="width: 40%;text-align: center"><?= substr($tag_buku->tanggal_bayar, 8, 2) . ' ' . $this->db->query("SELECT nama_bulan FROM bulan WHERE id_bulan='" . substr($tag_buku->tanggal_bayar, 5, 2) . "'")->row()->nama_bulan . ' ' . substr($tag_buku->tanggal_bayar, 0, 4) ?></td>
			</tr>
			<tr>
			...
			<tr>
				<td style="width: 60%;text-align: right">&nbsp;</td>
				<td style="width: 40%;text-align: center"><?= $user['nama'] ?></td>
			</tr>
		</tbody>
	</table>
	Tgl. Cetak: <?= $tgl_cetak ?>
