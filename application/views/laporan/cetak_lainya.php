...
$pdf->SetFont('Times', '', 12);
$pdf->SetX(8);
$pdf->MultiCell(19.5, 0.7, 'Jl. Balekambang, Kec. Selomerto, Kabupaten Wonosobo, Jawa Tengah 56361
', 0, 'C');
...
if (!empty($pem_lainya)) {
    ...
    foreach ($pem_lainya as $data) {
        ...
        $pdf->Cell(4, 0.6, $data->id_tag_buku, 1, 0, 'C');
        ...
        $pdf->Cell(4, 0.6, 'Rp. ' . number_format($data->besar_tagihan, 0, ',', '.'), 1, 0, 'C');
