            ...
            <div class="container">
                ...
                <form method="get" action="" class="form">
                    ...
                    <div class="form-group" id="form-nis">
                        ...
                        <select name="nisn" class="form-control" style="width: 50%">
                            <option value="">Pilih</option>
                            <?php
                            foreach ($nisn as $data) { // Ambil data tahun dari model yang dikirim dari controller
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td style="text-align: center;"><?php echo $data->id_tag_buku ?></td>
                                    ...
                                    <td style="text-align: center;"><?php echo 'Rp. ' . number_format($data->besar_tagihan, 0, ',', '.'); ?></td>
